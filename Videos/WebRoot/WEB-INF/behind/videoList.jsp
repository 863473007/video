...
<!-- 分页插件 -->
<%@ taglib uri="http://yanzhenwei.com/common/" prefix="yzw"%>
<!DOCTYPE html>
<html lang="zh-CN">
<head>
<meta charset="utf-8">
			...
			<div class="col-md-6">
				...
				<form class="navbar-form navbar-right" action="${pageContext.request.contextPath}/video/videoList.action" >
					...
					<div class="btn-group">
						...
						<input type="hidden" name="spearkerId" id="speakerId" />
					</div>
					<div class="btn-group">
				...
				<tbody>
					<c:forEach items="${page.rows}" var="video" varStatus="status">
						<tr>
							...
							<td>${video.time}</td>
							<td>${video.playNum}</td>
							<td><a href="videoEdit.action?id=${video.id}"><span
			            ...
			            <div class="col-md-12 text-right">
							 <yzw:page url="${pageContext.request.contextPath}/video/videoList.action" />
						</div>
