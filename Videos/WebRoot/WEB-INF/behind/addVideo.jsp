...
<html lang="zh-CN">
  ...
  <body>
	...
	<div class="container" style="margin-top: 20px;">
		  ...
		  <form class="form-horizontal" action="${pageContext.request.contextPath}/video/saveVideo.action">
							      ...
							      <div class="input-group-btn">
							        ...
							        <ul id="selectCourse" class="dropdown-menu">
							         <c:forEach items="${courseList}" var="course">
							             <li value="${course.id}" ><a href="#" onclick="showName(this,${course.id},2)">${course.courseTitle}</a></li>
							         </c:forEach>
			  ...
			  <div class="form-group">
			    ...
			    <div class="col-sm-10">
			      <input type="number" class="form-control" name="time" value="${video.time}" placeholder="精确到毫秒（正整数）">
			    </div>
			  </div>
